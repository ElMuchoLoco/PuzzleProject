...
public class PuzzleFixWorking extends JFrame implements ActionListener
{
	/*
	...
	* */
	...
	{
		PuzzleFixWorking ShowMe = new PuzzleFixWorking();
	...
	{ 
		...
		while(isolatedcounter < 12)
		{
			...
			if(ReplacerTileImageString.compareTo(GreyBoxGlobalStorageString) == 0 && e.getSource() == JTileArray[isolatedcounter+1]/* || e.getSource() == JTileArray[isolatedcounter-1] || e.getSource() == JTileArray[isolatedcounter+4] || e.getSource() == JTileArray[isolatedcounter-4]*/)
			{
			...
			Icon GreyBox = new ImageIcon("bart0.jpg"); //Stores The Grey Box As An Image
			JButton tile2 = new JButton(GreyBox); //Assigns The Grey Box To A JButton				
			something.setIcon(GreyBox);
			isolatedcounter =  12;
			}
			
			if(ReplacerTileImageString.compareTo(GreyBoxGlobalStorageString) == 0 && e.getSource() == JTileArray[isolatedcounter-1] /*|| e.getSource() == JTileArray[isolatedcounter+4] || e.getSource() == JTileArray[isolatedcounter-4]*/)
			{
			JTileArray[isolatedcounter].setIcon(StoreClickedImage); //If The String Of The Original Grey Box Is Found replace it's icon with the one of the swuare that has been clicked
			Icon GreyBox = new ImageIcon("bart0.jpg"); //Stores The Grey Box As An Image
			JButton tile2 = new JButton(GreyBox); //Assigns The Grey Box To A JButton				
			...
			if(ReplacerTileImageString.compareTo(GreyBoxGlobalStorageString) == 0 && e.getSource() == JTileArray[isolatedcounter+4] /*|| e.getSource() == JTileArray[isolatedcounter-4]*/)
			{
			JTileArray[isolatedcounter].setIcon(StoreClickedImage); //If The String Of The Original Grey Box Is Found replace it's icon with the one of the swuare that has been clicked
			Icon GreyBox = new ImageIcon("bart0.jpg"); //Stores The Grey Box As An Image
			JButton tile2 = new JButton(GreyBox); //Assigns The Grey Box To A JButton				
			...
			if(ReplacerTileImageString.compareTo(GreyBoxGlobalStorageString) == 0 && e.getSource() == JTileArray[isolatedcounter-4])
			{
			JTileArray[isolatedcounter].setIcon(StoreClickedImage); //If The String Of The Original Grey Box Is Found replace it's icon with the one of the swuare that has been clicked
			Icon GreyBox = new ImageIcon("bart0.jpg"); //Stores The Grey Box As An Image
			JButton tile2 = new JButton(GreyBox); //Assigns The Grey Box To A JButton				
